...
use crate::solana::{
    managers::ReferralManager,
    config::ConfigManager,
    constants::DEFAULT_REFERRAL_PROGRAM_ID,
};
...
mod tests {
    ...
    fn test_reward_distribution_calculation() {
        ...
        let total_distributed = distribution.project_reward + 
                               distribution.upper_reward + 
                               distribution.upper_upper_reward;
