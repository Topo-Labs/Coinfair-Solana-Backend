use crate::{
    dtos::solana_dto::{ApiResponse, CreateClassicAmmPoolAndSendTransactionResponse, CreateClassicAmmPoolRequest, CreateClassicAmmPoolResponse, ErrorResponse},
...
impl CpmmPoolCreateController {
    pub fn routes() -> Router {
        Router::new()
            .route("/create-amm", post(create_classic_amm_pool))
            .route("/create-amm-and-send-transaction", post(create_classic_amm_pool_and_send_transaction))
    }
}
