...
use crate::dtos::solana::clmm::swap::raydium::{
    ComputeSwapV2Request, RaydiumErrorResponse, RaydiumResponse, SwapComputeV2Data, TransactionSwapV2Request,
};
use crate::dtos::solana::clmm::swap::swap_v3::TransactionSwapV3Request;
...
impl SwapV2Controller {
    pub fn routes() -> Router {
        Router::new()
            ...
            .route("/transaction/swap-base-in", post(transaction_swap_v3_base_in_compatible))
            // .route("/transaction/swap-base-out", post(transaction_swap_v2_base_out))
            .route("/transaction/swap-base-out", post(transaction_swap_v3_base_out_compatible))
    }
}
...
pub async fn transaction_swap_v3_base_in_compatible(
    Extension(services): Extension<Services>,
...
pub async fn transaction_swap_v3_base_out_compatible(
    Extension(services): Extension<Services>,
    ValidationExtractor(request): ValidationExtractor<TransactionSwapV3Request>,
) -> Result<Json<RaydiumResponse<Vec<TransactionData>>>, StatusCode> {
