...
use crate::dtos::solana::clmm::refer::refer_dto::SetRefersDto;
...
pub async fn get_upper_from_db(
...
pub async fn get_uppers_from_db(
    Extension(services): Extension<Services>,
    Path(address): Path<String>,
...
pub async fn create_refers_from_db(
    Extension(services): Extension<Services>,
...
impl ReferController {
    pub fn app() -> Router {
        Router::new()
            .route("/refer/upper/:address", get(get_upper_from_db))
            .route("/refer/uppers/:address", get(get_uppers_from_db))
            .route("/refer/refers", post(create_refers_from_db))
    }
}
