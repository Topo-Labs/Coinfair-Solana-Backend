...
use crate::dtos::statics::static_dto::ApiResponse;
...
) -> Result<Json<ApiResponse<crate::dtos::statics::static_dto::ClmmConfigResponse>>, (StatusCode, Json<ErrorResponse>)> {
    info!("🔧 获取CLMM配置列表");
...
pub async fn save_clmm_config(
    Extension(services): Extension<Services>,
    ValidationExtractor(request): ValidationExtractor<crate::dtos::statics::static_dto::SaveClmmConfigRequest>,
) -> Result<Json<ApiResponse<crate::dtos::statics::static_dto::SaveClmmConfigResponse>>, (StatusCode, Json<ErrorResponse>)> {
...
pub async fn create_amm_config(
    Extension(services): Extension<Services>,
    ValidationExtractor(request): ValidationExtractor<crate::dtos::statics::static_dto::CreateAmmConfigRequest>,
) -> Result<Json<ApiResponse<crate::dtos::statics::static_dto::CreateAmmConfigResponse>>, (StatusCode, Json<ErrorResponse>)> {
...
pub async fn create_amm_config_and_send_transaction(
    ...
    Json<ApiResponse<crate::dtos::statics::static_dto::CreateAmmConfigAndSendTransactionResponse>>,
