...
pub async fn get_pool_list(
    ...
    Json<crate::dtos::solana::clmm::pool::listing::NewPoolListResponse>,
    (
        StatusCode,
        Json<crate::dtos::solana::clmm::pool::listing::NewPoolListResponse>,
    ),
> {
    ...
    match services.solana.query_pools_with_new_format(&params).await {
        ...
        Err(e) => {
            error!("❌ 池子列表查询失败: {:?}", e);
            let error_response = crate::dtos::solana::clmm::pool::listing::NewPoolListResponse {
                id: uuid::Uuid::new_v4().to_string(),
                success: false,
                data: crate::dtos::solana::clmm::pool::listing::PoolListData {
                    count: 0,
                    data: vec![],
                    has_next_page: false,
                },
...
pub async fn get_pools_by_ids(
    ...
    Json<crate::dtos::solana::clmm::pool::listing::NewPoolListResponse2>,
    (
        StatusCode,
        Json<crate::dtos::solana::clmm::pool::listing::NewPoolListResponse2>,
    ),
> {
    ...
    let ids = params.ids.clone().ok_or_else(|| {
        let error_response = crate::dtos::solana::clmm::pool::listing::NewPoolListResponse2 {
            id: uuid::Uuid::new_v4().to_string(),
            success: false,
            data: vec![],
        };
...
pub async fn get_pools_key_by_ids(
    ...
    Json<crate::dtos::solana::clmm::pool::info::PoolKeyResponse>,
    (StatusCode, Json<crate::dtos::solana::clmm::pool::info::PoolKeyResponse>),
> {
    info!("🔍 接收到池子密钥查询请求");

    // 验证必需参数
    let ids = params.get("ids").ok_or_else(|| {
        let error_response = crate::dtos::solana::clmm::pool::info::PoolKeyResponse {
            id: uuid::Uuid::new_v4().to_string(),
            success: false,
            data: vec![],
        };
