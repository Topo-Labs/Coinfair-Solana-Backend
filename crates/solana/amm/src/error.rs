...
pub enum ErrorCode {
    ...
    #[msg("invalid referral accounts count")]
    InvalidReferralAccountCount,
    #[msg("invalid referral accounts count")]
    InvalidUpperAccount,
    #[msg("invalid referral accounts count")]
    InvalidUpperUpperAccount,
    #[msg("invalid referral accounts count")]
    InvalidUpperTokenOwner,
    #[msg("invalid referral accounts count")]
    InvalidUpperTokenMint,
    #[msg("invalid referral accounts count")]
    InvalidUpperUpperTokenOwner,
    // #[msg("invalid referral accounts count")]
    // InvalidUpperUpperTokenOwner,
    ...
    InvalidBaseMint,
    #[msg("Create Pool: calculate_inverted_price - math overflow")]
    MathOverflow,
    #[msg("Create Pool: Base mint - calculate_inverted_price - division by zero")]
    DivisionByZero,
}
