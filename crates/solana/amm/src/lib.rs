...
solana_security_txt::security_txt! {
    ...
    contacts: "",
    policy: "",
    source_code: "https://github.com/Topo-Labs/Coinfair-Solana",
    preferred_languages: "en",
    auditors: "" //TODO
}

// #[cfg(feature = "localnet")]
// declare_id!("Fair7k4r8bF3aDEyWfuiyV4Qd3UtX6T1gBZm4XgQ39ip");

// #[cfg(not(feature = "localnet"))]
declare_id!("FA1RJDDXysgwg5Gm3fJXWxt26JQzPkAzhTA114miqNUX");
...
// 定义了多个接口，用于管理Configs, Pools, Liquidity, Rewards等
#[program]
pub mod amm_v3 {
    ...
    /// Swaps one token for as much as possible of another token across a single pool, support token program 2022; Meanwhile, enjoy reward.
    ///
    /// # Arguments
    ///
    /// * `ctx` - The context of accounts
