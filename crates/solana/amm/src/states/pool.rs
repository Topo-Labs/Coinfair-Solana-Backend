...
pub struct PoolState {
    ...
    pub liquidity: u128,
    /// The current price of the pool as a fifth_root(4*token_1/token_0) Q64.64 value
...
impl PoolState {
    ...
    pub fn get_tick_array_offset(&self, tick_array_start_index: i32) -> Result<usize> {
        ...
        let tick_array_offset_in_bitmap = tick_array_start_index / TickArrayState::tick_count(self.tick_spacing)
